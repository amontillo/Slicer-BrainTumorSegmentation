...
public:
 ...
 // *************************************
 // Begin AAM modification 
  template<class T>
    result_type operator()(T min, T max) { return _dist(_eng, min , max); }

  template<class T>
    result_type operator()(T max) { return _dist(_eng, 0 , max); }
